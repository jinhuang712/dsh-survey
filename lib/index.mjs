    ...
    parameters: {
      ...
      properties: {
        mode: {
          type: "string",
          description:
            '呈现模式（必选）："compact" = 单题紧凑卡片（类似简单提问，适合 1 个问题）；"inline" = 多题内嵌在对话流固定画幅（适合普通多题问卷）；"overlay" = 全屏浮层加宽（适合含对比题或需要更宽展示）。'
        },
        questions: {
          type: "array",
          description:
